...
#        check for perdictet result
       ...
       def callbb(self,expect,tstops,w_exe,w_in,dend_exe,dendinput,tresh,noghte1,train1,stORsh,num_syn,dendinput_in,num_syn_in):
            ...
            # dend_exe_in=[0,19,31,42]
            # dend_exe_in=[1,11,20,23,32,39,43,48]
            # dend_exe_in=[1,11,20,23,31,42,49]
            # dend_exe_in=[3,4,5,12,14,15,21,22,24,26,27,28,29,35,36,37,40,41,45,46,47,48,51,52,53]
            ...
            # print('dendpositon',DendPosition,secName,Output,'dendinput',dendinput)
            # print('dendpositon_in',DendPosition_in,secName_in,Output_in,'dendinput_in',dendinput_in)
            ListSynapse={}
            Listintfire={}
    ...
    #                  list_stimulator_i.append(stimulator_i)
           ...
           # #########ezafe 
            ...
            return vm,tmfff,tm,Rec_Wg_NMDA,Rec_Wg_GABA,secName, checkD,checkDnaro, checkD_i,checkD_imin,checkDnaro_i,checkDLtype ,Output,Output_in,DendPosition1#,Rec_Vol_Dend
       def timeStep(start_time,num_task):
                ...
                ktstarts = [150] * len(tstarts)
                ktdz = [200] * len(tstarts)
       ...
       def beforMain(self):
            ...
            timespan=20
            NumberOfspike=1
            # inputDict={'B':0.15,'Y':0.15,'E':0.4,'R':0.15,'S':0.15}
            # inputDict={'B':0.25,'Y':0.25,'R':0.25,'S':0.25}
            ...
            timespan_in=50
            NumberOfspike_in=15
            # inputDict_in={'B':0.2,'Y':0.2,'S':0.2,'R':0.2,'E':0}
            # assignInputTask_in={'YB':['Y','B','E'],'RS':['R','S','E'],'YS':['Y','S','E'],'RB':['R','B','E']}
            np.random.seed(123)
            ...
            dend_exe=[4,8,12,15,21,22,24,26,28,35,36,37,41,46,47,51,52,53,57,3,14,17,18,29,40,45,48,56,27,44]
            # dend_exe=[41,5,8]
            # dend_exe=[4,5,8,12,15,21,22,24,26,28,35,36,37,41,46,47,51,52,53,57,3,14,18,29,40,45,48,56,20,27]
            # dend_exe=[3,4,5,12,14,15,21,22,24,26,27,28,29,35,36,37,40,41,45,46,47,48,51,52,53]
            ...
            # ,checkDendVoltage,checkDendNmda ,checkDendCal,checkD,checkDnaro,checkD_cor,checkDnaro_cor
             ...
             ##############################################################
            return   w_exe ,Rec_Wg_NMDA,w_in,Rec_Wg_GABA,noghte1,secName,tmfff,checkD,checkDnaro,train1, checkD_i,checkD_imin,checkDnaro_i,checkDLtype,inputListSyn,Output, inputListSyn_in,Output_in,DendPosition1#,Rec_Vol_Dend,vm,tm
