...
#        check for perdictet result
       ...
       def callbb(self,expect,tstops,tstarts,w_exe,w_in,dend_exe,dendinput,dendinput_inh,tresh,noghte1,train1,stORsh,dendlst,w_exe_cor,dendinput_cor,tresh_cor,num_syn,num_syn_inh):
            ...
            seclist20_cor,secName_cor,pos_cor=func.makeSectionList3(self.cell,dend_exe,0,num_syn,3)  
            list_syn_ampa=[]
            list_nc_ampa=[]
            list_stimulator=[]
            list_syn_nmda=[]
           ...
           ############################################ # Glutamate thresholdjjjj
            ...
            for  i2_e,sec_e in enumerate(seclist2_inh):
                  b=func.set_position(0.8,0.85,num_syn_inh)   
                  for iff_e in range(num_syn_inh):
                      f =(i2_e*num_syn_inh)+iff_e
                      syn_i,nc_i,stimulator_i=func.putSynapse_in4(self.cell,sec_e,dendinput_inh[f],w_in[0][f],stORsh,b[iff_e],1,wmax,interval, tminrate , tmaxrate , wrate)
